...
class Conv2d(nn.Conv2d):  
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,  
        ...
        self.wq = nn.Parameter(torch.zeros((in_channels, out_channels, kernel_size, kernel_size)), requires_grad=False)
...
class Linear(nn.Linear):  
    def __init__(self, in_features, out_features):  
        ...
        self.wq = nn.Parameter(torch.zeros((in_features, out_features)), requires_grad=False)
