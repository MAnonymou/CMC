...
def main():
    ...
    qnn.load_state_dict(ckpt['state_dict'],strict=False)
    ...
    for pname, p in qnn.named_parameters():
        if 'wq' in pname:
            logger.info('weight_param:{},{} \n {}'.format(pname,p.size(),p))

    # state = {
    #     'state_dict': model_state_dict
    # }
    # torch.save(state, '/home/ming/coding/EQ-Net-CNN/mobilenet_v2_wq_w{}a{}.pt'.format(cfg.w_bit,cfg.a_bit))
